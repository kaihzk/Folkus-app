...
const EventsTable = () => {
  ...
  const update = (id, data) => {
    dispatch(actionsEvents.doUpdate(id, data));
  };
  ...
  return (
    <div>
      <Widget title={humanize('Events')} disableWidgetMenu>
        <Box className={classes.actions}>
          <Link to='/admin/events/new' className={classes.element}>
